		...
		<div id="hero" className="flex items-center justify-center flex-col py-20">
			<div className="text-center">
				<h1 className="text-2xl md:text-4xl mb-1 md:mb-3 text-gray-600 dark:text-gray-300 font-semibold">
					Hi, This is 
					<Typed className="text-2xl md:text-4xl mb-1 md:mb-3 text-indigo-600 dark:text-indigo-500 font-semibold" strings={[' Sunny Shah']} typeSpeed={180} backSpeed={160} loop></Typed>
				</h1>
				<p className="text-md md:text-xl max-w-md mb-3 text-gray-600 dark:text-gray-300">
					I am Front End Developer. 
					<br />
					I design and code beautifully experiences{' '}
				</p>
				<a
					href="#works"
